...
for(int te=1; te<=3; te++){
    ...
    switch(te){
case 1 :
    cout<<"turno de "<< nombre2 << " en 3 segundos" <<endl;
    break;
case 2 :
    cout<<"turno de "<< nombre2 << " en 2 segundos" <<endl;
    break;
    case 3 :
    cout<< "turno de "<< nombre2 <<" en 1 segundos" <<endl;
    break;
    default:
        break;
    }
...
rlutil::locate(1,25);
    ...
    cout << "Tanto " <<nombre<<" como "<<nombre2<<" han alcanzado la puntuacion objetivo de 500 o mas y empataron." << endl;
    }else if(puntuacionJugador>=puntuacionObjetivo && puntuacionJugador>puntuacionJugador2){
    cout << "Felicidades " <<nombre<<", has alcanzado la puntuacion objetivo de 500." << endl;
