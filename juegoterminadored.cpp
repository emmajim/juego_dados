...
rlutil::cls();
 for(int te=1; te<=3; te++){
    ...
    switch(te){
case 1 :
    if(puntuacionJugador<puntuacionObjetivo){
    ...
    drawSix(13 * i,4);
        ...
        default:
            ...
            if (contador_six2 == 6) {
                ...
                rlutil::locate(1,9);
                cout<<"sextete de " << vdados2[0] <<endl;
            }
            //fin de los combos
...
for(int te=1; te<=3; te++){
    ...
    switch(te){
case 1 :
    if(puntuacionJugador<puntuacionObjetivo && puntuacionJugador2<puntuacionObjetivo){
