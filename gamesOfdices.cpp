    ...
    drawSix(13 * i,4);
        ...
        default:
            ...
            if (vdados[0] == 6 && vdados[1] == 6 && vdados[2] == 6 && vdados[3] == 6 && vdados[4] == 6 && vdados[5] == 6) {
                ...
                lanzamiento = puntuacionObjetivo - puntuacionJugador2;
            } else {
                if (combos == 1) {
                    lanzamiento = maxComboValue * 10;
                } else if (combos >= 2) {
        ...
        if (six3 == 0) {
            puntuacionJugador2 += lanzamiento_mayor;
        } else {
            puntuacionJugador2 += 0;
            six3 = 0;
        }
        rlutil::locate(40,2);
        std::cout << "Puntuaje total: "<< puntuacionJugador2 <<" puntos" << std::endl << std::endl;
